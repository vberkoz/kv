    ...
    <div className="bg-white p-4 md:p-6 rounded-lg shadow hover:shadow-md transition-shadow">
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        <div className="flex-1 relative">
          <label htmlFor="api-key-input" className="sr-only">Your API Key</label>
          <input
            id="api-key-input"
            type="text"
          ...
          />
          {copied && (
            <div className="absolute right-2 top-1/2 -translate-y-1/2 text-green-600 animate-scale-in" aria-hidden="true">
      ...
      <div className="mt-3 flex items-start gap-2 text-xs md:text-sm text-gray-600 bg-blue-50 p-3 rounded" role="note">
        <svg className="w-4 h-4 text-blue-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
